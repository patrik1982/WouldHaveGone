...
import os
import argparse
from gwc.reader import GWCReader
...
class GWCDecompiler:
    ...
    def get_lua_bytecode(self, filename='cartridge.luac'):
        ...
        for obj_id, obj_addr in self.cartridge_data['objects'][1:]:
            ...
            if valid != 0:
                ...
                if object_type in object_types:
                    ...
                    medias.append(self.reader.read_raw(object_length))
        return medias
...
def decompile(filename):
    ...
    d.decompile()
    data = {}
    data['lua_bytecode'] = d.get_lua_bytecode()
    data['media'] = d.get_media_files()
    return data
